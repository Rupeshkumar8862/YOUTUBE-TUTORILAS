...
?>
                                 ...
                                 <!-- ======= Hero Section ======= -->
       <section style="background-image:url(/assets/img/aboutme/cta-bg.jpg) ;"id="hero" class="hero">
       <div class="container position-relative">
       <div class="row gy-5" data-aos="fade-in">
         <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
           <marquee behavior="" direction="">
             <h6 style="color:aliceblue ;font-size: xx-large;">Welcome to R.Technologies</h6>
           </marquee>
           <p style="color:#f6f6f6; ">We are team of freelancer and talented digital marketers and Effective, optimized
           ...
           <div class="d-flex justify-content-center justify-content-lg-start">
             <a style="background-color: #00796b; opacity:60%; font-size: larger;" href="Blog.php?page=1" class="btn-get-started">Latest Posts</a>
         ...
         <div class="col-lg-6 order-1 order-lg-2">
           <!-- if you want add pic -->
           <img src="assets/img/aboutme/hero-img-removebg-preview.png" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
         </div>
       </div>
     </div>
       ...
       <div class="container position-relative">
         <div class="row gy-4 mt-5">
           ...
           <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
             <div style="background-image: url(/assets/img/aboutme/hero-bg.jpg);background-repeat:round; " class="icon-box">
               <div style="color: aqua;" class="icon"><i class="bi bi-easel"></i></div>
               <h4 style="background-color: #00796b; opacity:60%; font-size: larger ;" class="title"><a href="index.php" class="stretched-link">All Software</a></h4>
             </div>
           </div>
           <!--End Icon Box -->

           <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
             <div style="background-image: url(/assets/img/aboutme/our-values-1.jpg );background-repeat:round;" class="icon-box">
               <div style="color: aqua;" class="icon"><i class="bi bi-gem"></i></div>
               <h4 style="background-color: #00796b; opacity:60%; font-size: larger;" class="title"><a href="" class="stretched-link">Web maintenance</a></h4>
             </div>
           </div>
           <!--End Icon Box -->

           <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
             <div style="background-image: url(/assets/img/aboutme/hgghgh.jpg);background-repeat:round;" class="icon-box">
               <div style="color: aqua;" class="icon"><i class="bi bi-geo-alt"></i></div>
               <h4 style="background-color: #00796b; opacity:60%; font-size: larger; " class="title"><a href="" class="stretched-link">CMS Website</a></h4>
             </div>
           </div>
                                                                                        <!--End Icon Box -->

           <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
             <div style="background-image: url(/assets/img/aboutme/cropped-view-professional-serious-finance-manager-holding-calculator-hands-checking-company-month-s-profits_176420-7931.jpg) ; background-repeat:round;" class="icon-box">
               <div style="color: aqua;" class="icon"><i class="bi bi-command"></i></div>
               <h4 style="background-color: #00796b; opacity:60%; font-size: larger;" class="title"><a href="" class="stretched-link">SEO Friendly</a></h4>
             </div>
           </div>
                                                                                           <!--End Icon Box -->
        </div>
          ...
          <div class="section-header">
           ...
           <p>We are a group of experienced designers, developers, and marketers who believe in the power of creative
            ...
            <div class="row gy-4">
             ...
             <img src="assets/img/portfolio/responsive_design_example1.png" class="img-fluid rounded-4 mb-4" alt="">
     ...
     <section id="clients" class="clients">
       <div class="container" data-aos="zoom-in">
         <h3 style="text-align: center;">Affiliations & Partners</h3>
         <p style="text-align: center;" </p>We are proud to have these reputed companies as our partners :
         ...
         <div class="clients-slider swiper">
           <div class="swiper-wrapper align-items-center">
             <div class="swiper-slide"><img src="assets/img/clients/bluehost.png" class="img-fluid" alt=""></div>
             <div class="swiper-slide"><img src="assets/img/clients/partners3.png" class="img-fluid" alt=""></div>
             <div class="swiper-slide"><img src="assets/img/clients/client-2.png" class="img-fluid" alt=""></div>
             <div class="swiper-slide"><img src="assets/img/clients/client-3.png" class="img-fluid" alt=""></div>
             <div class="swiper-slide"><img src="assets/img/clients/bigrock.png" class="img-fluid" alt=""></div>
             <div class="swiper-slide"><img src="assets/img/clients/client-5.png" class="img-fluid" alt=""></div>
             <div class="swiper-slide"><img src="assets/img/clients/client-6.png" class="img-fluid" alt=""></div>
             <div class="swiper-slide"><img src="assets/img/clients/hostinger.png" class="img-fluid" alt=""></div>
     ...
     <section id="stats-counter" class="stats-counter">
       <div class="container" data-aos="fade-up">
         <div class="slideshow-container">
           <div class="mySlides">
             <h3 style="text-align: center;">What our Happy Customers Says</h3>
         ...
         <div class="row gy-4 align-items-center">
           <div class="col-lg-6">
             <img src="assets/img/stats-img.svg" alt="" class="img-fluid"> </div>
           ...
           <a class="cta-btn" href="https://www.facebook.com/RUPESHKUMARYADA">Call To Action</a></div>
             ...
             <section style="background-image: url(#);" id="services" class="services sections-bg">
            <div class="container" data-aos="fade-up">
            <div class="section-header">
           <h2>Our Services</h2>
         ...
         <div class="section-header">
           ...
           <p>We are a group of experienced designers, developers, and marketers who believe in the power of creative
            ...
            <div class="row gy-4">
             ...
             <div class="member">
               <img src="assets/img/aboutme/img1-removebg-preview.png" class="img-fluid" alt="">
               <h4>Rupesh kumar</h4>
           ...
           <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
             <div class="member">
               <img src="assets/img/aboutme/jj.jpg" class="img-fluid" alt="">
               <h4>Jyoti Rani</h4>
